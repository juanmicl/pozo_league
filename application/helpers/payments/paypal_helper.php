...
function createPayment($apiContext, $data) {
  // ### Payer
  ...
  $redirectUrls
        ->setReturnUrl($data['baseUrl']."/paypal/".$data['id']."/success")
        ->setCancelUrl($data['baseUrl']."/paypal/".$data['id']."/failure");
  // ### Payment
...
function checkPayment($apiContext) {
